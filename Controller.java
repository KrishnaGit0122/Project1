public class Controller {
    ...
    public void insert(String artist, String song) {
        ...
        // If the size is greater than half of the capacity, double the size of table
        if (size >= capacity / 2) {
            doubleTable();
        }
        ...
        System.out.println("|" + artist.trim() + "| is added to the Artist database.");
        System.out.println("|" + song.trim() + "| is added to the Song database.");
    ...
    public void remove(String artist, String song) {
        ...
        while (table[index][0] != null) {
            if (table[index][0].equals(artist) && table[index][1].equals(song)) {
                ...
                table[index][1] = null;
                size--;
                System.out.println("|" + song.trim() + "| is removed from the Artist database.");
                return;
            }
        ...
        System.out.println("|" + song.trim() + "| does not exist in the Song database.");
    ...
    /**
     * When the hash table is almost half full, double the size to add more storage.
     */
     ...
     * CommandProcessor, this will print all of the artists present in the table
     *
     */
     ...
     * CommandProcessor, this will print all of the songs present in the table
     *
     */
